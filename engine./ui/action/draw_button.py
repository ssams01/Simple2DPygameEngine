...
class DrawRectButtonAction(): 
    ...
    def condition_to_act(self,data): 
      ...
      #if the method doesn't have the button specifications   
       if data == None: 
          return False 
       return True 
    ...
    #draws the button to the screen with the given specifications it gets from the passed in instance of Button
    #(represented by self)
