...
class DrawLetter: 
    ...
    def act(self,data):
     ...
     #draws a letter to the screen with the given specifications it gets from the passed in instance of Letter
     #(represented by self)
    def draw(self, screen):
       ...
       letter = font.render(str(self.entity_state.letter), True, self.entity_state.color)
